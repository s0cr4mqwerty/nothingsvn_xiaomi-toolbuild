...
work_dir=$(pwd)
source "$work_dir/bin/package/COREPATCH/A16/core/logging.sh"
source "$work_dir/bin/package/COREPATCH/A16/core/tools.sh"
source "$work_dir/bin/package/COREPATCH/A16/core/apk_ops.sh"
source "$work_dir/bin/package/COREPATCH/A16/core/patching.sh"
