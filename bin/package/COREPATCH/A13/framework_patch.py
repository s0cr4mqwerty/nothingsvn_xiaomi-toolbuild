...
#     directories = ["jar_temp/framework.jar.out/classes.dex.out", "jar_temp/framework.jar.out/classes2.dex.out", "jar_temp/framework.jar.out/classes3.dex.out", "jar_temp/framework.jar.out/classes4.dex.out", "jar_temp/framework.jar.out/classes5.dex.out", "jar_temp/framework.jar.out/classes6.dex.out"]
...
if __name__ == "__main__":
    ...
    # Now, directories will contain all paths that match the pattern
    modify_smali_files(directories)
