...
def modify_file(file_path, flag):
    ...
    if flag == "framework":
        method_patterns = {
            ...
            "checkCapability": re.compile(r'\.method.*checkCapability\(Ljava/lang/String;I\)Z'),
        ...
        if in_method:
            ...
            if line.strip() == '.end method':
                ...
                if method_type in [
                    ...
                    "isSecureLocked", "getMaxMiuiFreeFormStackCount", "canBeUpdate"
                    "setSecure", "shouldCheckUpgradeKeySetLocked", "notAllowCaptureDisplay", "verifyIsolationViolation"
                ]:
