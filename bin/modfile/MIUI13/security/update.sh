...
if [[ $rom_os == "MIUI" ]]; then
  ...
  cp -rf $work_dir/bin/modfile/MIUI13/security/permissions/privapp_whitelist_com.miui.securitycenter.xml $work_dir/build/baserom/images/product/etc/permissions/
  cp -rf $work_dir/bin/modfile/MIUI13/security/MIUISecurityCenter/* $work_dir/build/baserom/images/product/priv-app/MIUISecurityCenter
