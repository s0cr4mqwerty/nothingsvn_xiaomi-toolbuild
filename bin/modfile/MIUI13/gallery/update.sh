...
cp -rf $work_dir/bin/modfile/MIUI13/gallery/MIUIGallery/* $work_dir/build/baserom/images/product/priv-app/MIUIGallery
cp -rf $work_dir/bin/modfile/MIUI13/gallery/permissions/privapp_whitelist_com.miui.gallery.xml $work_dir/build/baserom/images/product/etc/permissions/
