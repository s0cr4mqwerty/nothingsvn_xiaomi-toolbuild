...
if [[ $rom_os == "OS1" ]]; then
mods "Update Appvault For OS1"
rm -rf $isSTOCKVault
mkdir -p $work_dir/build/baserom/images/product/priv-app/MIUIPersonalAssistant
cp -rf $work_dir/bin/modfile/OS1/appvault/MIUIPersonalAssistant/* $work_dir/build/baserom/images/product/priv-app/MIUIPersonalAssistant/
cp -rf $work_dir/bin/modfile/OS1/appvault/permissions/privapp_whitelist_com.miui.personalassistant.xml $work_dir/build/baserom/images/product/etc/permissions/
