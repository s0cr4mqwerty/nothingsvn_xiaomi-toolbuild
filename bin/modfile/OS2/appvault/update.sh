...
mods "Update Appvault For OS2"
rm -rf $isSTOCKVault
mkdir -p $work_dir/build/baserom/images/product/priv-app/MIUIPersonalAssistant
cp -rf $work_dir/bin/modfile/OS2/appvault/MIUIPersonalAssistant/* $work_dir/build/baserom/images/product/priv-app/MIUIPersonalAssistant/
cp -rf $work_dir/bin/modfile/OS2/appvault/permissions/privapp_whitelist_com.miui.personalassistant.xml $work_dir/build/baserom/images/product/etc/permissions/
